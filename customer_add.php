        ...
        <div class="flex-container">
            ...
            <div class="flex-container-radio">
                <div class="container">
                    ...
                    <label id="radio-label" for="male-radio">
<span class="radio">Male</span></label>
                </div>



                <div class="container">
                    <input type="radio" name="gender" value="female" id="female-radio" checked>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="aadhar" size="30" type="text" required />
            </div>
        </div>
        ...
        <div class="flex-container">
			...
			<div  class=container>
                ...
                <input name="imeino" size="30" type="text" required />
            </div>
