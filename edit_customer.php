...
<body>
    <form class="add_customer_form" action="edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    ...
                    <option value="Vyara" <?php if ($branch == 'Vyara') {?> selected="selected" <?php }?>>Vyara</option>
                    <option value="Navsari" <?php if ($branch == 'Navsari') {?> selected="selected" <?php }?>>Navsari</option>
                    <option value="Toronto" <?php if ($branch == 'Toronto') {?> selected="selected" <?php }?>>Toronto</option>
                    <option value="Goa" <?php if ($branch == 'Goa') {?> selected="selected" <?php }?>>Goa</option>
                </select>
            </div>
        </div>
        ...
        <div class="flex-container">
			...
			<div  class=container>
                <label>IMEI Number :</b></label><br>
                <input name="imeino" size="30" type="text" value="<?php echo $imeino ?>" required />
            </div>
        </div>
