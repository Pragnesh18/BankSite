...
$imeinumber = mysqli_real_escape_string($conn, $_POST["imeino"]);
...
$sql3 = "INSERT INTO customer (first_name,last_name,gender,dob,aadhar_no,email,phone_no,address,branch,account_no,pin,uname,pwd,imei) VALUES(
...
$sql4 = "INSERT INTO passbook".$id."(trans_date,remarks,debit,credit,balance) VALUES(
